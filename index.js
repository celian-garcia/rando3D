...
window.onload = function onload(){
        ...
        RANDO.SETTINGS.DEM_URL      = "json/trek/903469/dem.json";
        RANDO.SETTINGS.PROFILE_URL  = "json/trek/903469/profile.json";
        RANDO.SETTINGS.POI_URL      = "json/trek/903469/pois.geojson";
        ...
        var scene = new RANDO.Scene(canvas, false, "1.0" );
        scene.init();
