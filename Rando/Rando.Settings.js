...
RANDO.SETTINGS.PCAM_FOLLOW_SPEED = 25; // PathCamera speed when it follows trek
RANDO.SETTINGS.PCAM_RETURN_SPEED = 2500; // PathCamera speed when it comes back to default
