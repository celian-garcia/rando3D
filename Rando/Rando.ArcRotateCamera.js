...
(function () {
    ...
    RANDO.ArcRotateCamera = function (name, alpha, beta, radius, target, scene) {
    ...
    // Members
    RANDO.ArcRotateCamera.prototype.inertialAlphaOffset = 0;
    RANDO.ArcRotateCamera.prototype.inertialBetaOffset = 0;
    RANDO.ArcRotateCamera.prototype.inertialRadiusOffset = 0;
    RANDO.ArcRotateCamera.prototype.lowerAlphaLimit = null;
    RANDO.ArcRotateCamera.prototype.upperAlphaLimit = null;
    RANDO.ArcRotateCamera.prototype.lowerBetaLimit = 0.01;
    RANDO.ArcRotateCamera.prototype.upperBetaLimit = Math.PI;
    RANDO.ArcRotateCamera.prototype.lowerRadiusLimit = null;
    RANDO.ArcRotateCamera.prototype.upperRadiusLimit = null;
    RANDO.ArcRotateCamera.prototype.angularSensibility = 1000.0;
    RANDO.ArcRotateCamera.prototype.wheelPrecision = 3.0;

    RANDO.ArcRotateCamera.prototype._getTargetPosition = function () {
    ...
    RANDO.ArcRotateCamera.prototype._updateCache = function (ignoreParentClass) {
    ...
    // Synchronized
    RANDO.ArcRotateCamera.prototype._isSynchronizedViewMatrix = function () {
    ...
    // Methods
    RANDO.ArcRotateCamera.prototype.attachControl = function (canvas, noPreventDefault) {
    ...
    RANDO.ArcRotateCamera.prototype.detachControl = function (canvas) {
    ...
    RANDO.ArcRotateCamera.prototype._update = function () {
        // Keyboard
    ...
    RANDO.ArcRotateCamera.prototype.setPosition = function (position) {
    ...
    RANDO.ArcRotateCamera.prototype.getPosition = function () {
    ...
    RANDO.ArcRotateCamera.prototype._getViewMatrix = function () {
        // Compute
    ...
    RANDO.ArcRotateCamera.ZOOM_ON_FACTOR = 1;
    RANDO.ArcRotateCamera.prototype.zoomOn = function (meshes) {
        meshes = meshes || this._scene.meshes;

        var minMaxVector = BABYLON.Mesh.MinMax(meshes);
        var distance = BABYLON.Vector3.Distance(minMaxVector.min, minMaxVector.max);

        this.radius = distance * RANDO.ArcRotateCamera.ZOOM_ON_FACTOR;

        this.focusOn({min: minMaxVector.min, max: minMaxVector.max, distance: distance});
    };

    RANDO.ArcRotateCamera.prototype.focusOn = function (meshesOrMinMaxVectorAndDistance) {
